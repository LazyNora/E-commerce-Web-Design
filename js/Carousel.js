      ...
      <div class="slide-media | relative" style="--aspect-ratio: 2.072704081632653; --aspect-ratio-mobile: 1.314060446780552">
        ...
        <div class="res-mobile | md:hidden" style="height:20vw">
          <div class="slide-bg-mobile">
            <img
              src=${currentPath + item.img_mobile}
              sizes="100vw"
              width="1000"
              height="761"
              alt="${item.desc}"
...
const handleSlideChange = (swiper) => {
	const footerElement = swiper.slides[swiper.realIndex].querySelector(".slide-footer");
	if (footerElement) {
	...
	const contentElement = swiper.slides[swiper.realIndex].querySelector(".slide-content");
	if (contentElement) {
	...
	const paginationElement = document.querySelector(".custom-swiper-pagination");
