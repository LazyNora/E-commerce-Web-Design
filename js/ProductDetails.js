...
const normalStarReview =
  '<svg class="star-icon normalStar w-[14px] h-[14px]" focusable="false" aria-hidden="true" viewBox="0 0 24 24"><path d="M12 17.27 18.18 21l-1.64-7.03L22 9.24l-7.19-.61L12 2 9.19 8.63 2 9.24l5.46 4.73L5.82 21z"></path></svg>';
const halfStarReview =
  '<svg class="star-icon halfStar w-[14px] h-[14px]" focusable="false" aria-hidden="true" viewBox="0 0 24 24"><path d="m22 9.24-7.19-.62L12 2 9.19 8.63 2 9.24l5.46 4.73L5.82 21 12 17.27 18.18 21l-1.63-7.03zM12 15.4V6.1l1.71 4.04 4.38.38-3.32 2.88 1 4.28z"></path></svg>';
const borderStarReview =
  '<svg class="star-icon borderStar w-[14px] h-[14px]" focusable="false" aria-hidden="true" viewBox="0 0 24 24"><path d="m22 9.24-7.19-.62L12 2 9.19 8.63 2 9.24l5.46 4.73L5.82 21 12 17.27 18.18 21l-1.63-7.03zM12 15.4l-3.76 2.27 1-4.28-3.32-2.88 4.38-.38L12 6.1l1.71 4.04 4.38.38-3.32 2.88 1 4.28z"></path></svg>';
...
function saleCountDown() {
  ...
  (function (title, daysNo, hoursNo, minutesNo, secondsNo) {
    function updateCountdown(title, daysNo, hoursNo, minutesNo, secondsNo) {
      ...
      var daysRemaining =
        Math.floor(remainingTime / 86400000) >= 10
          ? Math.floor(remainingTime / 86400000)
          : "0" + Math.floor(remainingTime / 86400000);
      var hoursRemaining =
        Math.floor((remainingTime % 86400000) / 3600000) >= 10
          ? Math.floor((remainingTime % 86400000) / 3600000)
          : "0" + Math.floor((remainingTime % 86400000) / 3600000);
      var minutesRemaining =
        Math.floor((remainingTime % 3600000) / 60000) >= 10
          ? Math.floor((remainingTime % 3600000) / 60000)
          : "0" + Math.floor((remainingTime % 3600000) / 60000);
